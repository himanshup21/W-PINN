...
DWx = D1xgaussian(x_collocation, t_collocation, jx, jt, kx, kt).T
...
DWbc_left = D1xgaussian(x_bc_left, t_bc, jx, jt, kx, kt).T
DWbc_right = D1xgaussian(x_bc_right, t_bc, jx, jt, kx, kt).T

WValidation = gaussian(x_validation, t_validation, jx.cpu(), jt.cpu(), kx.cpu(), kt.cpu()).T
